...
function snapshot() {
  ...
  return { banks: [{ bankId: 'B', questionCount: 1 }], categories: [{ categoryKey: 'B|A', bankId: 'B', categoryId: 'A' }], levels: [{ levelKey: 'S|CUR' }], questions: [{ questionKey: 'B|Q1', bankId: 'B' }], players: [{ playerId: 'J1' }, { playerId: 'J3' }], matches: [match], participants: [{ matchPlayerId: 'M|J1', matchId: 'M', playerId: 'J1', active: true }, { matchPlayerId: 'M|J3', matchId: 'M', playerId: 'J3', active: true }], attempts: [], exposures: [], events: [draw, result], meta: [{ key: 'schemaVersion', value: 6 }, { key: 'seedVersion', value: 'x' }] };
}
