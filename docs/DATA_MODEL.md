...
Tablas: bancos, categorías por banco, niveles por escala, preguntas, jugadores, partidas históricas, participantes, intentos históricos, exposiciones y eventos históricos. Las preguntas pueden dividirse físicamente en varios CSV sin cambiar la identidad lógica del banco.
...
4. si cambió `seed_version`, sustituye filas propiedad de la semilla y conserva partidas/eventos locales;
